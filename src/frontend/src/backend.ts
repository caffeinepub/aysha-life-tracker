...
export class Backend implements backendInterface {
    ...
    async isUserDataPersisted(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isUserDataPersisted();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async loadUserData(): Promise<UserData> {
        if (this.processError) {
            try {
                const result = await this.actor.loadUserData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveUserData(arg0: CheckedItems, arg1: bigint, arg2: Array<Task>): Promise<void> {
        if (this.processError) {
            try {
